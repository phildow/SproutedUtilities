...
#import <SproutedUtilities/KFASHandlerAdditions-TypeTranslation.h>
...
//- (id)executeHandler:(NSString *)handlerName withParameters:(NSObject *)firstArg, ...
- (id)executeHandler:(NSString *)handlerName withParameters:(id)firstArg, ...
{
...
//- (id)executeHandler:(NSString *)handlerName error:(NSDictionary **)errorInfo withParameters:(NSObject *)firstArg, ...
- (id)executeHandler:(NSString *)handlerName error:(NSDictionary **)errorInfo withParameters:(id)firstArg, ...
{
    NSMutableArray *argumentsArray;
    va_list argList;
    id anArg;
...
withParametersFromArray:(NSArray *)argumentsArray
{
    ...
    @try
	{
        resultDesc = [self executeHandler:handlerName withParametersFromArray:argumentsArray];
	}
