...
#import <SproutedUtilities/AGKeychain.h>

#import <Security/Security.h>
#import <CoreFoundation/CoreFoundation.h>

#warning note that I've changed all the cString calls to utf8 calls. Don't know what the consequences of that might be
...
+ (NSString *)getPasswordFromKeychainItem:(NSString *)keychainItemName withItemKind:(NSString *)keychainItemKind forUsername:(NSString *)username
{
	...
	// Phil Dow change: Moved CFRelease outside of SecKeychainSearchCopyNext if statement
	CFRelease (search);
