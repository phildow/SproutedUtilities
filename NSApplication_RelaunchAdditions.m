...
#import <SproutedUtilities/NSApplication_RelaunchAdditions.h>

@implementation NSApplication (RelaunchAdditions)

- (void)relaunch:(id)sender
{
	NSString *relaunchPath = [[[NSBundle mainBundle] 
			resourcePath] 
			stringByAppendingString:@"/relaunch.app/Contents/MacOS/relaunch"];
